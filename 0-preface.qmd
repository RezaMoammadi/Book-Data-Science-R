...
5.  *Modeling*: Building and training predictive models using a range of machine learning algorithms (Chapters [-@sec-ch7-classification-knn] through [-@sec-ch14-clustering]).
