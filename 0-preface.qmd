...
Chapters [-@sec-chapter-intro-data-science] through [-@sec-chapter-data-preparation] establish the workflow and the foundations for working with data. Chapter [-@sec-chapter-intro-data-science], *Introduction to Data Science*, presents data science as an iterative process organized around Problem Definition, Data Acquisition, Data Understanding and Exploration, Data Preparation for Modeling, Modeling, Model Evaluation, and Communication and Deployment. It also positions machine learning within this broader process and introduces different analytical goals, including prediction, explanation, and discovering structure in data.

Chapter [-@sec-chapter-data-understanding], *Data Understanding and Exploratory*, focuses on learning what the available data contain before modeling decisions are made. It develops the use of feature types, numerical summaries, visualization, and exploratory analysis to investigate distributions, relationships, missingness, and unusual or implausible observations.
...
Chapters [-@sec-chapter-knn] through [-@sec-chapter-bayes] introduce classification and model assessment. Chapter [-@sec-chapter-knn], *Classification Using k-Nearest Neighbors*, provides an accessible introduction to supervised machine learning, including feature representation and model tuning. Chapter [-@sec-chapter-evaluation], *Model Evaluation*, develops the principles and measures needed to evaluate predictive models appropriately. Chapter [-@sec-chapter-bayes], *Naive Bayes*, introduces a probabilistic approach to classification.
...
Chapters [-@sec-chapter-regression] and [-@sec-chapter-glm] develop regression-based modeling. Chapter [-@sec-chapter-regression], *Regression Analysis*, examines relationships between numerical outcomes and explanatory variables using linear and nonlinear regression approaches. Chapter [-@sec-chapter-glm], *Generalized Linear Models*, extends regression modeling to binary and count outcomes for which ordinary linear regression is not appropriate.

Chapters [-@sec-chapter-trees] through [-@sec-chapter-clustering] broaden the modeling toolkit. Chapter [-@sec-chapter-trees], *Decision Trees and Random Forests*, develops tree-based approaches for prediction. Chapter [-@sec-chapter-neural-networks], *Neural Networks*, introduces the principles and application of neural networks for supervised prediction. Chapter [-@sec-chapter-clustering], *Clustering Using K-means*, turns to unsupervised learning and examines how observations can be grouped when predefined outcome labels are unavailable.
