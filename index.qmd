...
The book also includes the **liver** package, available on [CRAN](https://cran.r-project.org/web/packages/liver/index.html), which provides curated datasets and helper functions to support interactive learning.

You can always access the latest version of the book at  
👉 [https://uncovering-data-science.netlify.app](https://uncovering-data-science.netlify.app)  
and explore the source code or contribute via GitHub:  
👉 [https://github.com/RezaMoammadi/Book-Data-Science](https://github.com/RezaMoammadi/Book-Data-Science)
...
- 🐛 [Open an issue or pull request on GitHub](https://github.com/RezaMoammadi/Book-Data-Science)
