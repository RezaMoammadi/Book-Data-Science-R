...
```{r fig-venn-diagram, echo = FALSE, out.width = "70%", fig.cap = "The Venn diagram (top) visualizes the joint and marginal probabilities in Bayes’ Theorem. The corresponding probabilities are also expressed in the formula shown below."}
