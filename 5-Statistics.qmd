...
Within the Data Science Workflow, hypothesis testing helps move from exploratory patterns to formal statistical conclusions. In Section [-@sec-ch4-EDA-churn], exploratory analysis suggested that churn may be related to customer spending and service contacts. Hypothesis testing allows us to assess whether such patterns are statistically credible, while still requiring careful interpretation of assumptions, effect size, and practical relevance.
