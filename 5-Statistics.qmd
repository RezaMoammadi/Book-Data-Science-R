...
> *Try it yourself:* Test whether education level is associated with churn in the *churnCredit* dataset. Follow the same steps as above. For more information on the `education` variable, see Section [-@sec-EDA-categorical] in Chapter [-@sec-ch4-EDA].
