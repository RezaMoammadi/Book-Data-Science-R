...
## Machine Learning {#sec-ch2-machine-learning}
...
Although reinforcement learning is an important area of machine learning, it lies outside the scope of this book. Our focus is on supervised and unsupervised methods for structured, tabular data, where the main tasks involve prediction, classification, regression, and clustering. Readers interested in reinforcement learning are referred to *Reinforcement Learning: An Introduction* by @sutton1998reinforcement for a comprehensive treatment.
