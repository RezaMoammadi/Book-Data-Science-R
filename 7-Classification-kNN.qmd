...
```{r fig-ch7-knn-image, echo = FALSE, out.width = "55%", fig.cap = "A two-dimensional toy dataset with two classes (Class A and Class B) and a new data point (dark star), illustrating the kNN algorithm with k = 3 and k = 6."}
...
p = ggplot(data = train_set, aes(x = age, y = ratio)) +
...
p + geom_point(data = test_set, aes(x = age, y = ratio), colour = "orange", size = size, shape = 1) +
  geom_point(data = test_set, aes(x = age, y = ratio), colour = "orange", size = 1, shape = 4)
```
...
ggplot(data = train_set, aes(x = age, y = ratio)) +
  ...
  guides(color = guide_legend(title = "Drug Type"), 
         shape = guide_legend(title = "Drug Type")) +
  geom_point(data = test_set, aes(x = age, y = ratio), colour = "orange", size = 15, shape = 1) +
  geom_point(data = test_set, aes(x = age, y = ratio), colour = "orange", size = 1, shape = 4) +
