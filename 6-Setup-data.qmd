...
<div class="author">— Niels Bohr</div>
:::
:::
...
We illustrate the train–test split using R and the **liver** package. We return to the *churnCredit* dataset introduced in Chapter [-@sec-ch4-EDA-churn], where the goal is to predict customer churn using machine learning models (discussed in the next chapter). First, following data preparation step in Section [-@sec-ch4-EDA-churn] we load and prepare the dataset as follows:
