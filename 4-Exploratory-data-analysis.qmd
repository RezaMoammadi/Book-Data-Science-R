...
Before deciding how to handle missing values, it is helpful to assess their extent. The **naniar** package provides convenient tools for visualizing missingness. The function `gg_miss_var()` displays the proportion of missing observations for each feature:
