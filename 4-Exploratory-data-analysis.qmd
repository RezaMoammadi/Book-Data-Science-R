...
-   `day.mins`, `day.calls`, `day.charge`: Metrics for daytime usage, Continuous numerical.
-   `eve.mins`, `eve.calls`, `eve.charge`: Metrics for evening usage, Continuous numerical.
