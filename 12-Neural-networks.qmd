...
```{r fig-ch12-active-fun-comparison, echo = FALSE, fig.cap = "Comparison of common activation functions: sigmoid, tanh, and ReLU."}
...
ggplot(data = train_set) +
  geom_histogram(mapping = aes(x = age), color = "white", fill = "#2C7BB6") +
