...
# The Data Science Workflow and the Role of Machine Learning {#sec-chapter-intro-data-science}
...
1.  *Problem Understanding*: Define the research, business, or practical problem, clarify the decision to be supported, and determine what a successful analysis should achieve.
...
3.  *Data Understanding*: Examine the structure, quality, feature types, distributions, patterns, and relationships in the data, and investigate missingness, unusual observations, implausible values, and redundancy.

4.  *Data Preparation*: Prepare the data for model development and reliable evaluation by partitioning and resampling appropriately, preventing data leakage, handling identified data-quality issues, and preparing categorical and numerical features.
...
6.  *Evaluation*: Assess model performance using appropriate validation procedures and metrics, and determine whether the results address the original objective and are useful in practice.

7.  *Deployment*: Put analytical results into use through decision-support tools, prediction systems, dashboards, reports, or other applications, and monitor their performance and relevance over time.

```{r fig-ds_DSW, echo = FALSE, out.width="85%"}
#| fig-cap: "The Data Science Workflow is an iterative framework for structuring data science and machine learning projects. It connects problem understanding, data acquisition, data understanding and exploration, data preparation for modeling, modeling, evaluation, and deployment."
...
The workflow also clarifies the structure and scope of this book. The main emphasis is on Problem Understanding, Data Understanding, Data Preparation, Modeling, and Evaluation. Data Acquisition and Deployment are included because they are essential to a complete data science workflow, but they are discussed primarily at a conceptual level. Chapter [-@sec-chapter-data-understanding] develops Data Understanding, Chapter [-@sec-chapter-data-preparation] focuses on Data Preparation, and later chapters introduce specific modeling approaches and methods for evaluating their performance.
...
## Problem Understanding {#sec-ds-Problem-Understanding}
...
7.  Why is Problem Understanding important? Give an example of how a poorly framed problem could lead to misleading or practically unhelpful results.
...
9.  Explain the difference between Data Understanding and Data Preparation. Give two examples of tasks that belong mainly to each stage.
...
19. What trade-offs may arise among predictive performance, interpretability, computational efficiency, robustness, and ease of deployment when selecting a model?

### Applied Scenarios {.unnumbered .unlisted}

20. An online retailer wants to predict whether a visitor will make a purchase during a website session. Describe how this project could proceed through all seven stages of the Data Science Workflow, from Problem Understanding to Deployment.
...
22. A university wants to identify students who may be at risk of dropping out. Describe:
    ...
    c.  issues that should be investigated during Data Understanding;
    d.  one preparation step that may be needed before modeling; and
    e.  one ethical concern related to using the model.

23. A company develops a churn prediction model with high test-set accuracy, but managers do not understand how to interpret or act on its predictions. Which stages of the Data Science Workflow may need to be revisited? Explain your answer.
