...
```{r fig-RStudio-window-1, echo = FALSE, out.width = '75%'}
...
```{r fig-install-packages, echo = FALSE, out.width = '75%'}
...
```{r fig-load-data, echo = FALSE, out.width = '75%', fig.cap = "Using the 'Import Dataset' tab in RStudio to load data."}
...
```{r fig-load-data-2, echo = FALSE, out.width = '75%', fig.cap = "Adjusting import settings in RStudio before loading the dataset."}
