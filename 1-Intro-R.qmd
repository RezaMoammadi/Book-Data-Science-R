...
A concise overview of these operators, grouped by their function, is presented in Table [-@tbl-common-operators]. These operators are fundamental to working with data in R, particularly when selecting subsets, defining conditions, or constructing logical expressions. Beyond these basic arithmetic and logical operators, R also provides special operators, introduced next.
