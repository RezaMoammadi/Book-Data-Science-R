...
```{r fig-ch1-tiny-gains, echo = FALSE, out.width  = '70%'}
...
ggplot(df, aes(x = x, y = y, color = function_label)) +
  geom_line(size = 0.6, arrow = arrow(length = unit(0.2, "cm"))) +
  annotate("text", x = 210, y = 27, label = "1% Better Every Day", color = "darkgreen", size = 5) +
  annotate("text", x = 295, y = 3, label = "Static", color = "blue", size = 5) +
  labs(title = "The Power of Tiny Gains",
       x = "Days",
       y = "Improvement",
       color = "Function") + #scale_color_manual(values=c("#CC6666", "#9999CC", "#66CC99"))
