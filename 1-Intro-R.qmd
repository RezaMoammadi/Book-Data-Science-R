...
A concise overview of the most frequently used operators is given in Table [-@tbl-common-operators].
...
These operators are fundamental to working with data in R, particularly when selecting subsets, defining conditions, or constructing logical expressions.
