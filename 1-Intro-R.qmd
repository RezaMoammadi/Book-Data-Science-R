...
This chapter is designed for true beginners—readers who may have never written a line of code before. If you are new to R, programming, or data science, you are in the right place. Drawing on years of teaching experience, this chapter addresses the most common questions students raise during lectures and labs, particularly when working with real data for the first time.
...
1.  Visit the [RStudio website](https://www.rstudio.com/download).
...
### How Functions Work in R {#sec-ch1-functions-in-r}
...
#| echo: false
#| tbl-cap: "Behavior of code chunk options in R Markdown and their impact on code execution, visibility, and output in rendered documents."
#| out.width: NULL
...
datasets = data.frame(
    ...
    `Run Code` = c("$\\checkmark$", "$\\times$", "$\\checkmark$", "$\\checkmark$", "$\\checkmark$", "$\\checkmark$"),
    `Show Code` = c("$\\times$", "$\\checkmark$", "$\\checkmark$", "$\\checkmark$", "$\\checkmark$", "$\\times$"),
    Output = c("$\\checkmark$", "$\\times$", "$\\checkmark$", "$\\checkmark$", "$\\checkmark$", "$\\times$"),
    Plots = c("$\\checkmark$", "$\\times$", "$\\checkmark$", "$\\checkmark$", "$\\checkmark$", "$\\times$"),
    Messages = c("$\\checkmark$", "$\\times$", "$\\times$", "$\\checkmark$", "$\\checkmark$", "$\\times$"),
    Warnings = c("$\\checkmark$", "$\\times$", "$\\checkmark$", "$\\times$", "$\\checkmark$", "$\\times$"),
    Errors = c("$\\checkmark$", "$\\times$", "$\\checkmark$", "$\\checkmark$", "$\\times$", "$\\times$")
  )

kable(datasets, format = format, booktabs = TRUE, escape = FALSE) %>%
