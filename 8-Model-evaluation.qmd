...
> *Practice:* Repeat the kNN classification from Section [-@sec-ch7-knn-churn] using $k = 2$. Compute the resulting confusion matrix and calculate the precision, recall, and F1-score. How do these values compare with those for $k = 5$? Which metrics increase, which decrease, and what does this reveal about the effect of $k$ on model behaviour?
