...
::: {#tbl-confusion-matrix .table}
| *Predicted*       | Positive                                        | Negative                                    |
|------------------|----------------------------|--------------------------|
| *Actual Positive* | [**True Positive (TP)**]{style="color: green;"} | [False Negative (FN)]{style="color: red;"}  |
| *Actual Negative* | [False Positive (FP)]{style="color: red;"}      | [True Negative (TN)]{style="color: green;"} |

Confusion matrix for binary classification, summarizing correct and incorrect predictions based on whether the actual class is positive or negative.
:::
