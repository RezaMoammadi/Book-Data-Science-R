...
These exercises reinforce the main ideas of the chapter by combining conceptual understanding, interpretation of regression output, model comparison, diagnostic reasoning, and practical implementation in R. The hands-on sections use the `house`, `diamonds`, and `bike_demand` datasets from the **liver** package.
