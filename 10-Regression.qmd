...
```{r fig-scoter-plot-simple-reg, echo = FALSE, out.width = "80%", fig.cap = "Scatter plot of daily revenue (€) versus daily spend (€) for 40 observations, with the fitted least-squares regression line (red) showing the linear relationship."}
...
### Applications Using the Diamonds Dataset {.unnumbered}
